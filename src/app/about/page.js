...
const teamMembers = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1607987565270-300555398d0e?q=80&w=1470&auto=format&fit=crop'
  },
  {
    id: 2,
    name: 'Sophie Lefèvre',
    ...
    image: 'https://images.unsplash.com/photo-1592078686547-824fa6ea644e?q=80&w=1470&auto=format&fit=crop'
  },
  {
    id: 3,
    name: 'Yamamoto Kenji',
    ...
    image: 'https://images.unsplash.com/photo-1563279541026-40f77771f662?q=80&w=1470&auto=format&fit=crop'
  },
  {
    id: 4,
    name: 'Marie Dubois',
    ...
    image: 'https://images.unsplash.com/photo-1596147983440-9cb3d55c671d?q=80&w=1470&auto=format&fit=crop'
  }
];
...
const achievements = [
  {
    ...
    description: 'Ouverture du premier restaurant à Paris avec notre Chef fondateur Tanaka Hiroshi.'
  },
  {
    year: '2014',
    title: 'Prix de l\'Excellence Culinaire',
    description: 'Reconnaissance de notre engagement pour la qualité et l\'authenticité de notre cuisine.'
  },
  {
    year: '2017',
    title: 'Certification développement durable',
    description: 'Engagement pour des produits de la mer issus de la pêche durable et responsable.'
  },
  {
    year: '2020',
    title: 'Rénovation du restaurant',
    description: 'Nouveau décor zen et élégant pour améliorer votre expérience.'
  },
  {
    year: '2023',
    title: 'Mention dans le Guide Michelin',
    description: 'Recommandation pour notre cuisine authentique et notre service attentionné.'
  }
];
...
const values = [
  {
    title: 'Authenticité',
    description: 'Nous préparons nos plats selon les méthodes traditionnelles japonaises.'
  },
  {
    title: 'Qualité',
    description: 'Nous utilisons uniquement des ingrédients frais et de saison pour garantir des saveurs exceptionnelles.'
  },
  {
    title: 'Durabilité',
    description: 'Nous nous engageons à réduire notre impact environnemental et à promouvoir une pêche responsable.'
  },
  {
    title: 'Hospitalité',
    description: 'Nous accueillons nos clients comme des invités, dans la tradition de l\'omotenashi japonais.'
  }
];
      ...
      <Box sx={{ 
        ...
        <Box 
          sx={{ 
            ...
            height: '50vh',
            width: '100%',
            backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?q=80&w=1474&auto=format&fit=crop)',
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Découvrez notre histoire, notre équipe et notre passion pour la cuisine japonaise authentique
              </Typography>
            </motion.div>
          </Container>
        </Box>
                ...
                <Grid item xs={12} md={6}>
                  <motion.div variants={itemVariants}>
                    ...
                    <Typography variant="body1" sx={{ mb: 3 }}>
                      Fondé en 2010 par le Chef Tanaka Hiroshi, YahpadSushi est né d'une passion pour la cuisine japonaise authentique et le respect des traditions culinaires. Notre mission : offrir une expérience gastronomique qui transporte nos clients au cœur du Japon.
                    </Typography>
                    <Typography variant="body1" sx={{ mb: 3 }}>
                      Le nom "YahpadSushi" est un hommage à la ville natale du Chef Tanaka, combinant tradition et innovation - à l'image de notre cuisine qui respecte les méthodes ancestrales tout en intégrant des touches contemporaines.
                    </Typography>
                    <Typography variant="body1">
                      Au fil des années, notre restaurant est devenu une référence de la gastronomie japonaise à Paris. Nous continuons d'évoluer tout en restant fidèles à nos valeurs : authenticité, qualité et hospitalité.
                    </Typography>
                  </motion.div>
                </Grid>
                <Grid item xs={12} md={6}>
                  ...
                  >
                    <Box sx={{ 
                      ...
                      '&::before': {
                        ...
                        top: '0',
                        left: { xs: '11px', md: index % 2 === 0 ? 'auto' : '50%' },
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  <Typography variant="body1" sx={{ mb: 4 }}>
                    YahpadSushi se distingue par son engagement envers l'authenticité japonaise et la qualité des ingrédients. Chaque détail, de la préparation du riz à la découpe du poisson, est exécuté avec précision et respect des traditions.
                  </Typography>
